      ...
      <div class="row">
        <div class="col-lg-7">
          <div class="banner_content">
            <h3 class="text-uppercase">Hell0, nice to meet you!</h3>
            ...
            <div class="d-flex align-items-center">
              <a class="primary_btn" title="Hire Me" href="#"><span>Hire Me<i class="fad fa-bullhorn pl-2"
                style="font-size: 24px; transform: translate(3px, 3px);"></i></span></a>
              </div>
            </div>
          </div>
          <div class="col-lg-5">
  ...
  <section class="about_area section_gap" id="profile">
      ...
      <div class="row justify-content-start align-items-center">
        ...
        <div class="offset-lg-1 col-lg-5">
          <div class="main_title text-left">
            <h2>Profile</h2>
            <p>
              Someone who wants to become a professional Web Developer with the aim of revolutionizing the IT world.
            </p>
            <p>
              Even though I am an amateur, I currently know several frameworks from various programming languages such
              as Bootstrap and Laravel. My expertise tends to be more towards Front-end Programming.
            </p>
            <p>
              My favorite quote is <strong>Need Not To Know.</strong> from Detective Conan
            </p>
            <a class="primary_btn" title="Get My CV" href="#"><span>Get My CV<i class="fad fa-file-invoice pl-2"
              style="font-size: 24px; transform: translate(3px, 3px);"></i></span></a>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            <div class="main_title">
              ...
              <p>
                Here are a percentage of some of the programming languages that I have mastered so far.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="filters-content">
          <div class="row portfolio-grid justify-content-center">
            <div class="col-lg-4 col-md-6 all finished">
              <div class="portfolio_box">
                ...
                <div class="short_info">
                  <h4>Restoran</h4>
                  <p>Project Test Ujikom SMK Prakarya Internasional Bandung Tahun Ajaran 2019/2020</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 all finished latest">
              <div class="portfolio_box">
                <div class="single_portfolio">
                  <img class="img-fluid w-100" src="/assets/img/bimtek.jpeg"
                  alt="Bimbingan Teknisi Mitra Manajemen Dearah">
                  <div class="overlay"></div>
            ...
            <div class="col-lg-4 col-md-6 all finished">
              <div class="portfolio_box">
                ...
                <div class="short_info">
                  <h4>E-Mading</h4>
                  <p>Project Akhir Tahun SMK Prakarya Internasional</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 all following latest">
              <div class="portfolio_box">
                <div class="single_portfolio">
                  <img class="img-fluid w-100" src="/assets/img/harunozuka-and-comrade.png"
                  alt="Prof. Harunozuka & Comrade">
                  <div class="overlay"></div>
    ...
    <section class="contact_area" id="contact">
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <div class="col-md-12 text-right">
              <button title="Send Message" type="submit" value="submit" class="primary_btn">
                Send Message<i class="fad fa-paper-plane pl-2"
                style="font-size: 24px; transform: translate(3px, 3px);"></i>
              </button>
            </div>
          </form>
        </div>
      ...
      <div class="embed-responsive embed-responsive-16by9">
        <iframe class="section_gap embed-responsive-item"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7047122522176!2d107.58782811407994!3d-6.925857094995903!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e6002ca1a6c5%3A0xbbb1518487a1823c!2sJl.%20Terusan%20Pasirkoja%2C%20Babakan%20Tarogong%2C%20Kec.%20Bojongloa%20Kaler%2C%20Kota%20Bandung%2C%20Jawa%20Barat!5e0!3m2!1sid!2sid!4v1597425847874!5m2!1sid!2sid&output=embed"
        width="1110" height="555" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"
      ...
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="footer_top flex-column">
            <div class="text-left">
              <h2
              style="font-size: 36px; font-weight: 700; margin-bottom: 15px; line-height: 50px; text-transform: uppercase;">
            Follow Me</h2>
            <p>Here is my Social Media Account</p>
          </div>
          <div class="footer_social">
            <a title="My Facebook" href="https://www.facebook.com/rezkyrizaldi30" target="_blank"><i
              class="fab fa-facebook"></i></a>
              <a title="My Twitter" href="https://twitter.com/RezkyRizaldi1" target="_blank"><i
                class="fab fa-twitter"></i></a>
                <a title="My Instagram" href="https://instagram.com/rezkyrizaldii" target="_blank"><i
                  class="fab fa-instagram"></i></a>
                  <a title="My GitHub" href="https://github.com/RezkyRizaldi" target="_blank"><i
        ...
        <a href="#" class="top" style="display: inline"><i class="fad fa-chevron-up"></i></a>
